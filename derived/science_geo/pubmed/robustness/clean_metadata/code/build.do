...
program main
    foreach samp in demsci { //natsub demsci {
        *qui clean_mesh, samp(`samp')
        di "done clean_mesh"
        *qui clean_date, samp(`samp')
        di "done clean_date"
        *qui clean_journal, samp(`samp')
        di "done clean_journal"
        *qui clean_pubtype, samp(`samp')
        di "done clean_pubtype"
        *qui clean_authors, samp(`samp')
        di "done clean_authors"
        *qui clean_affls, samp(`samp')
        di "done clean_affls"
        *qui reshape_mult_affiliations, samp(`samp')
        di "done reshape_mult_affiliations"
        *qui reshape_mesh_terms, samp(`samp')
...
program reshape_mult_affiliations
	...
	cap drop *_raw athrs* num_affiliations* journal_na gr num_athrs nterms pub_type most_affiliations to_drop pt* start raw_pt
