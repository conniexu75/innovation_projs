...
program make_panel
    ...
    use id pmid which_athr which_affl year journal_abbr cite_count athr_id athr_name using ../external/openalex/cleaned_all_all_jrnls, clear
    merge m:1 athr_id year using ../external/insts/filled_in_panel, assert(1 2 3) keep(3) nogen
    ...
    gen years_since_pub = 2022-year+1
    gen avg_cite_yr = cite_count/years_since_pub
    bys pmid: replace avg_cite_yr = . if _n != 1
    sum avg_cite_yr
...
/*    foreach v in inst inst_id country country_code city msacode msa_comb {
        rename `v' c_`v'
    }*/
