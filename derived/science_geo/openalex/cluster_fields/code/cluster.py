...
cleaned_samp = pd.read_stata("../external/samp/cleaned_all_all_jrnls.dta")
...
mesh_terms = pd.read_stata("../external/samp/contracted_gen_mesh_all_jrnls.dta")
...
for text_column in ['text1', 'text2', 'text3', 'text4']:
    ...
    result_df = result_df.append(collapsed_data[['athr_id', 'year', 'cluster_label']], ignore_index=True)
